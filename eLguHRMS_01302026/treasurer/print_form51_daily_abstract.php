...
$treasurer_name = $treasurer_title = $accountant_name = $accountant_title = '';
...
// Fetch Form51 records for the given date & collector
$stmt = $mysqli->prepare("
    SELECT id, or_no, date_issued, payor_name, grand_total
    FROM form51
...
<head>
  <meta charset="UTF-8">
  <title>Daily Abstract Report</title>
  ...
  <style>
    ...
    .signature-line {
      ...
      width: 220px; /* will be adjusted by JS */
...
<div class="container mt-4 mb-5 report-container">
  ...
  <div class="header-text">
    ...
    <h5>DAILY ABSTRACT OF FORM 51 GENERAL COLLECTION PER COLLECTOR</h5>
  </div>
...
document.addEventListener("DOMContentLoaded", () => {
  document.querySelectorAll(".signature-block").forEach(block => {
    ...
    if (name && line) {
      ...
      line.style.width = (nameWidth + 60) + "px"; // dynamically adjust underline to name
    }
  });
});
</script>
