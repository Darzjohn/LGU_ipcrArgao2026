        ...
        <div class="modal-body">
          <div class="row g-3">
            ...
            <div class="col-md-3">
              ...
              <input type="number" step="0.01" id="add_gross" name="gross_receipts" class="form-control tax-input">
            </div>
            <div class="col-md-3">
              <label>Salaries</label>
              <input type="number" step="0.01" id="add_sal" name="salaries" class="form-control tax-input">
            </div>
            <div class="col-md-3">
              <label>Real Property Income</label>
              <input type="number" step="0.01" id="add_rpt" name="real_property_income" class="form-control tax-input">
            </div>
            ...
            <div class="col-md-3">
              ...
              <input type="text" id="add_gr_tax" name="gr_tax_due" class="form-control" readonly>
            </div>
            <div class="col-md-3">
              <label>Salaries Tax</label>
              <input type="text" id="add_sal_tax" name="sal_tax_due" class="form-control" readonly>
            </div>
            <div class="col-md-3">
              <label>Real Property Tax</label>
              <input type="text" id="add_rpt_tax" name="rpt_tax_due" class="form-control" readonly>
            </div>
            <div class="col-md-3">
              <label>Surcharge</label>
              <input type="text" id="add_surcharge" name="surcharge" class="form-control" readonly>
            </div>

            <div class="col-md-3">
              <label>Basic Tax</label>
              <input type="number" step="0.01" id="add_basic" name="basic_tax" class="form-control tax-input" value="5.00">
            </div>
            <div class="col-md-3">
              <label>Additional Tax</label>
              <input type="number" step="0.01" id="add_additional" name="additional_tax" class="form-control tax-input" value="0.00">
            </div>
            <div class="col-md-3">
              <label>Total Due</label>
              <input type="text" id="add_total_due" name="total_due" class="form-control" readonly>
            </div>
            <div class="col-md-6">
...
// ✅ Trigger recompute on any relevant input
["input", "change"].forEach(evt => {
  document.querySelectorAll("#addCTCModal input, #addCTCModal select").forEach(el => {
    el.addEventListener(evt, computeAddCTC);
  });
});

// ✅ Compute when modal opens
document.getElementById("addCTCModal").addEventListener("shown.bs.modal", computeAddCTC);
</script>
...
<!-- ✅ TAX COMPUTATION SCRIPT FOR EDIT -->
<script>
...
// ✅ Trigger recompute on input/change
document.querySelectorAll(".tax-input-edit, input[id^='edit_date_issued_'], input[id^='edit_basic_'], input[id^='edit_additional_']").forEach(el => {
  ["input", "change"].forEach(evt => {
