...
$dashboardTitle = match($role) {
    ...
    'hr' => 'HR Dashboard',
    'hr_staff' => 'HR Staff Dashboard',
    'employee' => 'Employee Dashboard',
    'assessor', 'assessment_clerk' => 'Assessment Dashboard',
    'treasurer', 'cashier' => 'Treasurer Dashboard',
    default => 'Dashboard',
};
?>
...
<div class="content-area p-4">
  <div class="container-fluid">
    <div class="glass-card">
      <h2 class="mb-3"><i class="bi bi-speedometer2"></i> <?= $dashboardTitle ?></h2>
