...
// ✅ Step 2: Temporarily insert with a placeholder RPTSP number
$temp_rptsp_no = "TEMP-" . uniqid();

$stmt = $mysqli->prepare("
    INSERT INTO tax_bills (
        rptsp_no, assessment_id, property_id, tax_year, assessed_value, basic_tax_rate, basic_tax, sef_tax, adjustments
    ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
");
$stmt->bind_param(
    "siidddddd",
...
// ✅ Step 3: Generate proper RPTSP number
// Pattern: RPTSP-[property_id]-[incremental id of this new record]
$rptsp_no = "RPTSP-" . $property_id . "-" . $tax_bill_id;

// ✅ Step 4: Update the tax bill with the new RPTSP number
...
// ✅ Step 5: Mark assessment as finalized
