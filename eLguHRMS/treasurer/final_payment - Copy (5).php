...
try {
    ...
    // Prepare insert statement (✅ corrected parameter order and types)
    $stmt = $mysqli->prepare("
    ...
    // ✅ Corrected bind_param type string — must have 34 placeholders
    $types = "ssssiisssssssddddddddsssssidddssss";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $stmt->bind_param(
            ...
            $amount,
            $amount,
            $payment_mode,  // ✅ Now properly handled as string
            $bank_name,
            $check_date,
            $check_amount
        );
