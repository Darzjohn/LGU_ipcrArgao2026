...
// ✅ Improved logic for previous payment visibility
// Always fetch previous payment when there is more than one selected OR "CheckAll"
if (count($selected_ids) > 1 || isset($_POST['check_all'])) {
...
// ✅ Show Previous Payment if available
